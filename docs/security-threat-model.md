...
| SEC-003 | Provider-controlled text could include terminal control characters | Medium | Tracked in [issue 79](https://github.com/mcqueary/graver/issues/79): human-facing rendering must neutralize controls without altering retained evidence or JSON. |
