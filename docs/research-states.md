...
| Research complete | `completed` | The researcher considers the current task complete. | No action is required unless research is reopened. | Offline; does not approve retrieval. |
