...
same privileges of participation are extended to everyone who participates in good
...
acknowledge the report, protect confidentiality as far as reasonably possible, and
disclose information only as needed to investigate, protect participants, obtain
agreed neutral assistance, or meet a legal obligation.

Reports will be considered promptly and in good faith. Investigation may include
reviewing relevant messages or repository activity and, when appropriate,
contacting participants or witnesses. Enforcement actions ordinarily remain private
to protect those involved, although a mutually agreed or safety-required community
communication may sometimes be appropriate.

## Addressing and repairing harm

If an investigation finds that this Code of Conduct has been violated, the project
maintainer may use the following enforcement ladder according to the impact on the
people involved and the community. More serious incidents may skip earlier steps.
...
2. **Temporarily limited activities**
   - **Event:** A repeated violation after a warning, or a first more-serious
     violation.
   - **Consequence:** A private, written warning with a time-limited restriction on
     specified channels, activities, or interactions.
   - **Repair:** Examples include reflection, apology, and thoughtful re-entry after
     the restriction.
3. **Temporary suspension**
   - **Event:** A repeated pattern not resolved by warnings, or a single serious
     violation.
   - **Consequence:** Temporary removal from community interaction with stated
     conditions for return.
   - **Repair:** Respecting the suspension, meeting the conditions for return, and
     reintegrating thoughtfully.
4. **Permanent ban**
   - **Event:** A pattern that other steps have failed to resolve, or a violation so
     serious that community safety cannot otherwise be maintained.
   - **Consequence:** Access to project community spaces and communication channels
     is removed. Permanent bans should be rare and supported by strong reasons.
   - **Repair:** There may be no safe repair within this community.

This ladder is guidance rather than a limit on reasonable judgment needed to
protect participants and the project.

## Scope

This Code of Conduct applies within project community spaces, including repository
issues, pull requests, discussions, reviews, and official communications. It also
applies when an individual officially represents the project in public or other
spaces, such as through an official email address, social account, or appointed
project role.
