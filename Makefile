...
doccheck: ## Check public application docstring coverage and style
	uv run --group dev ruff check --select D --ignore D105,D107 src/graver/acquisition.py src/graver/application.py src/graver/database.py src/graver/errors.py src/graver/evidence.py src/graver/progress.py src/graver/records.py src/graver/research.py src/graver/workspace.py
